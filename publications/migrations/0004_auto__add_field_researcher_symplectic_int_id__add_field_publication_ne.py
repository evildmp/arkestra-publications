...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Researcher.symplectic_int_id'
        db.add_column('publications_researcher', 'symplectic_int_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Publication.new_id'
        db.add_column('publications_publication', 'new_id', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Researcher.symplectic_int_id'
        db.delete_column('publications_researcher', 'symplectic_int_id')

        # Deleting field 'Publication.new_id'
        db.delete_column('publications_publication', 'new_id')
