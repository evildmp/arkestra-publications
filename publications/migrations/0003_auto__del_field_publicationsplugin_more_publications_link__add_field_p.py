...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PublicationsPlugin.more_publications_link'
        db.delete_column('cmsplugin_publicationsplugin', 'more_publications_link_id')

        # Adding field 'PublicationsPlugin.group_dates'
        db.add_column('cmsplugin_publicationsplugin', 'group_dates', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Changing field 'PublicationsPlugin.format'
        db.alter_column('cmsplugin_publicationsplugin', 'format', self.gf('django.db.models.fields.CharField')(max_length=25))


    def backwards(self, orm):
        
        # Adding field 'PublicationsPlugin.more_publications_link'
        db.add_column('cmsplugin_publicationsplugin', 'more_publications_link', self.gf('django.db.models.fields.related.ForeignKey')(related_name='publications_plugin_link', null=True, to=orm['contacts_and_people.Entity'], blank=True), keep_default=False)

        # Deleting field 'PublicationsPlugin.group_dates'
        db.delete_column('cmsplugin_publicationsplugin', 'group_dates')

        # Changing field 'PublicationsPlugin.format'
        db.alter_column('cmsplugin_publicationsplugin', 'format', self.gf('django.db.models.fields.IntegerField')())
