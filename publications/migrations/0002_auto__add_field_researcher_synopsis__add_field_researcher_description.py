...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Researcher.synopsis'
        db.add_column('publications_researcher', 'synopsis', self.gf('django.db.models.fields.related.ForeignKey')(related_name='research_synopsis', null=True, to=orm['cms.Placeholder']), keep_default=False)

        # Adding field 'Researcher.description'
        db.add_column('publications_researcher', 'description', self.gf('django.db.models.fields.related.ForeignKey')(related_name='research_description', null=True, to=orm['cms.Placeholder']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Researcher.synopsis'
        db.delete_column('publications_researcher', 'synopsis_id')

        # Deleting field 'Researcher.description'
        db.delete_column('publications_researcher', 'description_id')
