...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('publications_researcher', (
            ('person', self.gf('django.db.models.fields.related.OneToOneField')(related_name='researcher', unique=True, primary_key=True, to=orm['contacts_and_people.Person'])),
            ('research_synopsis', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('research_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('publishes', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('symplectic_access', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('symplectic_id', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True)),
        ))
        db.send_create_signal('publications', ['Researcher'])
        ...
        db.create_table('publications_publication', (
            ...
            ('created_when', self.gf('django.db.models.fields.TextField')(null=True)),
            ('last_modified_when', self.gf('django.db.models.fields.TextField')(null=True)),
            ('public_dspace_handle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('needs_refetch', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('publications', ['Publication'])

        # Adding model 'BibliographicRecord'
        db.create_table('publications_bibliographicrecord', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('publication', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bibliographic_records', to=orm['publications.Publication'])),
            ('data_source', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('id_at_source', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('verification_status', self.gf('django.db.models.fields.TextField')(null=True)),
            ('times_cited', self.gf('django.db.models.fields.TextField')(null=True)),
            ('reference_count', self.gf('django.db.models.fields.TextField')(null=True)),
            ('abstract', self.gf('django.db.models.fields.TextField')(null=True)),
            ('associated_authors', self.gf('django.db.models.fields.TextField')(null=True)),
            ('authors', self.gf('django.db.models.fields.TextField')(null=True)),
            ('awarded_date', self.gf('django.db.models.fields.TextField')(null=True)),
            ('begin_page', self.gf('django.db.models.fields.TextField')(null=True)),
            ('book_author_type', self.gf('django.db.models.fields.TextField')(null=True)),
            ('commissioning_body', self.gf('django.db.models.fields.TextField')(null=True)),
            ('confidential', self.gf('django.db.models.fields.TextField')(null=True)),
            ('doi', self.gf('django.db.models.fields.TextField')(null=True)),
            ('edition', self.gf('django.db.models.fields.TextField')(null=True)),
            ('editors', self.gf('django.db.models.fields.TextField')(null=True)),
            ('end_page', self.gf('django.db.models.fields.TextField')(null=True)),
            ('filed_date', self.gf('django.db.models.fields.TextField')(null=True)),
            ('finish_date', self.gf('django.db.models.fields.TextField')(null=True)),
            ('isbn_10', self.gf('django.db.models.fields.TextField')(null=True)),
            ('isbn_13', self.gf('django.db.models.fields.TextField')(null=True)),
            ('issn', self.gf('django.db.models.fields.TextField')(null=True)),
            ('issue', self.gf('django.db.models.fields.TextField')(null=True)),
            ('journal', self.gf('django.db.models.fields.TextField')(null=True)),
            ('journal_article_type', self.gf('django.db.models.fields.TextField')(null=True)),
            ...
            ('medium', self.gf('django.db.models.fields.TextField')(null=True)),
            ('name_of_conference', self.gf('django.db.models.fields.TextField')(null=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True)),
            ('number', self.gf('django.db.models.fields.TextField')(null=True)),
            ('number_of_pages', self.gf('django.db.models.fields.TextField')(null=True)),
            ('number_of_pieces', self.gf('django.db.models.fields.TextField')(null=True)),
            ('parent_title', self.gf('django.db.models.fields.TextField')(null=True)),
            ('patent_number', self.gf('django.db.models.fields.TextField')(null=True)),
            ('patent_status', self.gf('django.db.models.fields.TextField')(null=True)),
            ('pii', self.gf('django.db.models.fields.TextField')(null=True)),
            ('place_of_publication', self.gf('django.db.models.fields.TextField')(null=True)),
            ('publication_date', self.gf('django.db.models.fields.TextField')(null=True)),
            ('publication_status', self.gf('django.db.models.fields.TextField')(null=True)),
            ('publisher', self.gf('django.db.models.fields.TextField')(null=True)),
            ('series', self.gf('django.db.models.fields.TextField')(null=True)),
            ('start_date', self.gf('django.db.models.fields.TextField')(null=True)),
            ('title', self.gf('django.db.models.fields.TextField')(null=True)),
            ('version', self.gf('django.db.models.fields.TextField')(null=True)),
            ('volume', self.gf('django.db.models.fields.TextField')(null=True)),
            ('number_of_authors', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('first_author', self.gf('django.db.models.fields.TextField')(null=True)),
            ('last_author', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('publications', ['BibliographicRecord'])

        # Adding model 'BiblioURL'
        db.create_table('publications_bibliourl', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bibliographic_record', self.gf('django.db.models.fields.related.ForeignKey')(related_name='urls', to=orm['publications.BibliographicRecord'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('link', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('publications', ['BiblioURL'])

        # Adding model 'Authored'
        db.create_table('publications_authored', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('researcher', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored', to=orm['publications.Researcher'])),
            ('publication', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored', to=orm['publications.Publication'])),
            ('bibliographic_record', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored', to=orm['publications.BibliographicRecord'])),
            ('visible', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_a_favourite', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('reverse_sort_cue', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
        ))
        db.send_create_signal('publications', ['Authored'])

        # Adding model 'PublicationsPlugin'
        db.create_table('cmsplugin_publicationsplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='publications_plugin', null=True, to=orm['contacts_and_people.Entity'])),
            ...
            ('favourites_only', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('heading_level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3)),
            ('publications_heading_text', self.gf('django.db.models.fields.CharField')(default='Publications', max_length=50)),
            ('more_publications_link', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='publications_plugin_link', null=True, to=orm['contacts_and_people.Entity'])),
        ))
        db.send_create_signal('publications', ['PublicationsPlugin'])


    def backwards(self, orm):
        
        # Deleting model 'Researcher'
        db.delete_table('publications_researcher')

        # Deleting model 'Publication'
        db.delete_table('publications_publication')

        # Deleting model 'BibliographicRecord'
        db.delete_table('publications_bibliographicrecord')

        # Deleting model 'BiblioURL'
        db.delete_table('publications_bibliourl')

        # Deleting model 'Authored'
        db.delete_table('publications_authored')

        # Deleting model 'PublicationsPlugin'
        db.delete_table('cmsplugin_publicationsplugin')
    ...
    models = {
        ...
        'publications.bibliographicrecord': {
            ...
            'first_author': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '255', 'primary_key': 'True'}),
            ...
            'last_author': ('django.db.models.fields.TextField', [], {'null': 'True'}),
        ...
        'publications.publicationsplugin': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'publications_plugin'", 'null': 'True', 'to': "orm['contacts_and_people.Entity']"}),
            ...
            'more_publications_link': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'publications_plugin_link'", 'null': 'True', 'to': "orm['contacts_and_people.Entity']"}),
        ...
        'publications.researcher': {
            ...
            'person': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'researcher'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['contacts_and_people.Person']"}),
            'publishes': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'research_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'research_synopsis': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
